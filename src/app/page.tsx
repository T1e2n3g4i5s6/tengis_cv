  ...
  return (
    <div className="w-screen h-screen bg-gray-900 p-6 ">
      <div className=" w-1/3 lg:w-1/5 h-full shadow-lg shadow-gray-400 bg-gray-800  ">
        <div className="flex flex-col justify-center h-2/5 items-center">
        ...
        <div className="flex flex-col justify-center h-3/5 items-center">
          <div className="w-full h-2/5 flex justify-center flex-wrap">
            ...
            {frontend?.map((data, index) => {
              return (
                <div className="w-1/2 h-auto">
                  ...
                  <div className="w-full flex justify-center text-gray-400 text-xs">
                    {data.level}
                  </div>
                </div>
              );
          ...
          <div className="w-full h-1/5 bg-red-200"></div>
        </div>
        <div></div>
      </div>
    </div>
